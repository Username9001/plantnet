...
body {
  background: linear-gradient(rgba(1, 1, 1, 0.2), rgba(1, 1, 1, 0.6)),
    url("https://plantmonitor.ams3.digitaloceanspaces.com/uploads/background.jpg");
...
.container {
  margin-top: 24px;
  margin-bottom: 24px;
  background: rgb(222, 222, 222, 0.1);
  box-shadow: 0 8px 32px 0 rgba(31, 93, 135, 0.27);
